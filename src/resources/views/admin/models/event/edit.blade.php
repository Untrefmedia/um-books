...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-9">
                    {!! Form::text('start_date', $event->start_date, ['class' => 'form-control start_date','autocomplete'=>"off"]) !!}
                </div>
            </div>
    ...
    ?>
         ...
         <div class="form-group">
                ...
                <div class="col-sm-9">
                {{ Form::select('venue_id', $venues, $event->venue_id, array('class'=>'form-control', 'placeholder'=>'Select')) }}
                </div>
            </div>
         ...
         <div class="form-group">
                ...
                <div class="col-sm-9">
                        ...
                        {{Form::select('freq', $freesky,$event->byday, array('class'=>'form-control freq'))}}
...
days_checkers =  {!! $event->byday?$event->byday:null !!};

$(document).ready(function(){

    
$('.freq option[value={{$event->freq}}]').attr('selected','selected');


$(':checkbox').each(function(a,b){

if(days_checkers.indexOf($(b).val())!="-1"){
